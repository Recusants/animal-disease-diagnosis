...
?>
    ...
    <section id="contact" style="height: 100%; background-image: url(images/zim/rgw.jfif);">
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-12">
                </div>
                <div class="col-md-6 col-sm-12" style="background-color:darkgrey;">
                    <h4 style="color: red;">By creating this account you agree that the owner is a professional and trustworthy.</h4>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select type="text" name="user_type" class="form-control">
                                ...
                                <option value="Professional Farmer">Professional Farmer</option>
                            </select>
                        </div>   
                        <div class="form-group">
